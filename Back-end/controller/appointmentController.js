...
const createAppointment = async (req, res) => {
    ...
    const appointmentAlreadyBook = await Appointment.findOne({user: req.user.userId});
    ...
    sendAppointmentToDoctor({
        name: `${getDoctor.firstName} ${getDoctor.lastName}`,
...
const getAllAppointment = async (req, res) => {
    ...
    // accessPermission(req.user, appointments[0].user._id)
    // const doctorAppointments = appointments.filter(appointment => appointment.doctor._id)
